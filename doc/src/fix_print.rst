...
* keyword = *file* or *append* or *screen* or *title* or *first*
...
The equal-style variable used to specify timesteps must take values > 0.
To also print on step 0, use the keyword *first* with option *yes*.
