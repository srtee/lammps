...
void PairLJ1264CutCoulLong::compute(int eflag, int vflag)
{
  ...
  double r,r2inv,r4inv,r6inv,forcecoul,forcelj,factor_coul,factor_lj;
...
void PairLJ1264CutCoulLong::coeff(int narg, char **arg)
{
  ...
  // epsilon and sigma may be the string "mix" to request mixing at init time
  bool mix_eps = (strcmp(arg[2],"mix") == 0);
  bool mix_sig = (strcmp(arg[3],"mix") == 0);
...
double PairLJ1264CutCoulLong::init_one(int i, int j)
{
  ...
  // (no r^-4 tail correction: the r^-4 term is short-ranged)
...
double PairLJ1264CutCoulLong::single(int i, int j, int itype, int jtype,
                                 ...
                                 double &fforce)
{
  double r2inv,r4inv,r6inv,r,grij,expm2,t,erfc,prefactor;
